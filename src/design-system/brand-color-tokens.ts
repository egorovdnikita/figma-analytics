// Box UI | Tokens — коллекция Color (10 hue-режимов), сгенерировано из Figma-переменных.
// Только пять токенов пространства "brand" реально зависят от режима — Box UI использует
