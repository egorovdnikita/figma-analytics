// Figma Analytics | Tokens — коллекция Rounding (режимы плотности: Low/Medium/Hight — так они
// названы в самом Figma-файле), сгенерировано из Figma-переменных. Это отдельная от
// приложения шкала скруглений (--radius-*) — приложение использует свою упрощённую шкалу
